...
export class PickupCardComponent  implements OnInit {
  ...
  @Input() pickup: PickupModel = {id:'p3',status: 'hold',address: 'add',city: 'city',zip:'31230',createdAt: '11/04/2022',updatedAt: '13/04/2022',notes:' Two pair of pants.',userId:'xx'};
